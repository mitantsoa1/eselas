                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="accueil" class="navbar-brand" >retour à l'accueil</a></li>
                                        ...
                                        <li>
                                            <a href='francais'  onclick='cours(cours)'>cours </a>
                                        </li>
                                        <li>
                                            <a href='francais'  onclick='exercice(exercice)'>exercice</a>
                                        </li>
                                        <li>
                                            <a href='francais'  onclick='evaluation(evaluation)'>evaluation</a>
                                        </li>
