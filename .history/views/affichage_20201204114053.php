        ...
        <form class="form-horizontal" method="POST" action="sauverV">
            ...
            <div class="form-group">
                <label class="control-label " for="id">id:</label>        
                    <input type="text" class="form-control" id="idVoit" placeholder="Entrer la marque de la voiture" name="id">
            </div>
            <div class="form-group">
                <label class="control-label " for="marque">Marque:</label>        
                    <input type="text" class="form-control" id="marqueVoit" placeholder="Entrer la marque de la voiture" name="marque">
            </div>

            <div class="form-group">
                <label class="control-label" for="matricule">Matricule:</label>         
                    <input type="text" class="form-control" id="matriculeVoit" placeholder="Entrer le matricule" name="matricule">
            </div>

            <div class="form-group">
                <label class="control-label" for="matricule">Couleur:</label>        
                <input type="text" class="form-control" id="couleurVoit" placeholder="Entrer le couleur" name="couleur">             
            </div>

            <div class="form-group">
                <label class="control-label" for="place">Nombre de place:</label>        
                <input type="text" class="form-control" id="placeVoit" placeholder="Entrer le nombre de places" name="place">             
            </div>
