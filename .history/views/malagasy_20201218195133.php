                ...
                echo '<div class= "'.$table[$i]->categorie.'">
                    <table class= "'.$table[$i]->categorie.'">
                        ...
                        <tr  class="commentaire">
                            <td>
                                <button onclick="envoyer('.$table[$i]->id_comment.')"><i class="fa fa-comment fa-3x"></i></button>
                            </td>
                        </tr>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="" method="post"
            <div class="form-group">
                <textarea class="form-control" id="commentContent" name="commentContent" placeholder="Entrer votre commentaire"></textarea>
            </div>
        ...
        <button type="submit" class="btn btn-info" data-dismiss="modal" id="btnCommenter" name="btnCommenter">commenter</button>
