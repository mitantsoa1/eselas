...
<div class="container-fluid" >
        ...
        <form class="form-horizontal" method="POST" action="sauverV">
            ...
            <div class="form-group">
                <label class="control-label " for="id">id:</label>        
                    <input type="text" class="form-control" id="idV" placeholder="Enter la marque de la voiture" name="id">
            </div>
            <div class="form-group">
                <label class="control-label " for="marque">Marque:</label>        
                    <input type="text" class="form-control" id="marqueV" placeholder="Enter la marque de la voiture" name="marque">
            </div>

            <div class="form-group">
                <label class="control-label" for="matricule">Matricule:</label>         
                    <input type="text" class="form-control" id="matriculeV" placeholder="Enter le matricule" name="matricule">
            </div>

            <div class="form-group">
                <label class="control-label" for="matricule">Couleur:</label>        
                <input type="text" class="form-control" id="couleurV" placeholder="Enter le couleur" name="couleur">             
            </div>

            <div class="form-group">
                <label class="control-label" for="place">Nombre de place:</label>        
                <input type="text" class="form-control" id="placeV" placeholder="Enter le nombre de places" name="place">             
            </div>
    ...
    ?>
          <p>
            ...
            <select name="proprietaire" id="proprietaireV">
            ...
            <div class="form-group">  
                <div class="row">      
                    <div class="col-sm-offset-2 col-sm-2">
                        <a class="btn btn-warning" id="sauverV" value="Sauver">Sauver</a>
                    </div>
                </div>
            </div>
        </form>  
    ...
    <div class="row tab">
        <div class="col-md-5  ">
            ...
            <a href="enregProp" class="btn btn-info  m-l-250">Ajouter</a>
        </div>
        ...
        <div class="col-md-7 tab">
                <table  class="m-t-100 table ">
                    ...
                    echo "<tr>
                            ...
                            <a href='#' id='modifierP' onclick='modifierVoit(".$tab[$i]->matricule.")'>Modifier</a>
                            </td>
                ...
                <a href="enregVoit" class="btn btn-info m-l-100 ">Ajouter</a>
        </div>
    </div> 
