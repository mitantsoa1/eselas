...
?>
 ...
 <div class="row">
    ...
    <div class="row">
        <div class="col-md-4">
            <div id="title3">Image</div>  
        </div>
        <div class="col-md-4">
            <div id="title4">Image</div>  
        </div>
        <div class="col-md-4">
            <div id="title5">Image</div>  
        </div>

        <div class="col-md-4">
            <div id="contenu2">Contenu</div>  
        </div>
        <div class="col-md-4">
            <div id="contenu3">Contenu</div>  
        </div>
        <div class="col-md-4">
            <div id="contenu4">Contenu</div>  
        </div>
    </div>
