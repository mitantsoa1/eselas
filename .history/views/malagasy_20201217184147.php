                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php 
                             ...
                             for ($i=0;$i<count($table);$i++) {
                                 echo "
                                        <li>
                                            <a href='francais'  onclick='cours(".$table[$i]->categorie.")'>cours </a>
                                        </li>
                                        <li>
                                            <a href='francais'  onclick='exercice(".$table[$i]->categorie.")'>exercice</a>
                                        </li>
                                        <li>
                                            <a href='francais'  onclick='evaluation(".$table[$i]->categorie.")'>evaluation</a>
                                        </li>
                                    ";
                             }
                        ?>
