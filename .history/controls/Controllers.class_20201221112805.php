        ...
        public function publierFr(){
            ...
            if (isset($_POST['btnP'])) {
                ...
                $db  ->insert("publication")
                             ->parametters(["titre","contenu","photo","id_professeur","id_matiere"])
                             ->execute([$titre,$contenu,$photo,$table[0]->id_professeur,$tab[0]->id_matiere]);
               self::loadView("francais.php");
            }
        }
        public function publierMlg(){
            // echo $_SESSION['matiere'];
            if (isset($_POST['btnPMlg'])) {
                require_once('Models/Database.class.php');
                $db = new Database();
                Database::init("localhost", "eselas", "root", "");
               ...
               self::loadView("malagasy.php");
               $_SESSION['contenu']=$titre;
