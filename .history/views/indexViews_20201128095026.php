...
<body>
    ...
    <form action="?action=registerV" method="post" class="formulaire" style="display: inline;margin-left:20%;">
        <input type="submit" name="btnIndex" class=" btn btn-primary" value="Clique ici pour enregistrer votre voiture">        
    </form>
