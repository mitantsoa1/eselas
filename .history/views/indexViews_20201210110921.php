...
<head>
    ...
    <link rel="stylesheet" href="Publics/css/navigation.css">
...
?>
            ...
            <div id="monCarousel" class="carousel slide" data-ride="carousel" style="height:500px;">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src="Publics/images/152288.jpg" alt="" style="width:100%;height:500px;" >
 ...
 <div class="contenu container">
    ...
    <div class="row">
        <div class="col-md-5">
            <div class="title" id="title1">Image</div>  
        </div>
        <div class="col-md-7">
            <div class="title" id="contenu1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias excepturi temporibus neque repellendus vel vitae nihil? Vel, nihil. Vitae minima laborum fuga cupiditate vero porro aspernatur assumenda voluptas ex officia?</div>  
        </div>
    </div>
        <h2>MISSION</h2>
        <div class="row">
            <div class="col-md-4">
                <div class="title" id="title2">Image</div>  
            </div>
            <div class="col-md-4">
                <div class="title" id="title3">Image</div>  
            </div>
            <div class="col-md-4">
                <div class="title" id="title4">Image</div>  
            </div>

            <div class="col-md-4">
                <div class="title" id="contenu2">Contenu</div>  
            </div>
            <div class="col-md-4">
                <div class="title" id="contenu3">Contenu</div>  
            </div>
            <div class="col-md-4">
                <div class="title" id="contenu4">Contenu</div>  
            </div>
        </div>
        <h2>VISION</h2>
    <div class="row">
        <div class="col-md-4">
            <div class="title" id="title5">Image</div>  
        </div>
        <div class="col-md-4">
            <div class="title" id="contenu5">Contenu</div>  
        </div>
        <div class="col-md-4">
            <div class="title" id="contenu6">Contenu</div>  
        </div>
 </div>
