...
<body>
    <div class="container">
        ...
        <h2>français</h2>
        <form action="publierFr" method="POST" enctype="multipart/form-data">
        ...
        <?php
            ...
            for($i=0;$i<count($table);$i++){
                ...
                echo '<id="idSectinAff" section class="clsectionAff container-fluid  offset-sm-3  col-sm-6 mt-5 >
                    <table>
                        <tr>
                            <td>
