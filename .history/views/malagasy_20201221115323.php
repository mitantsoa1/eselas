...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
            ...
            <div class="navbar-header">
                ...
                <div class="navbar-header">
                    <?php 
                        // include('Controls/Controllers.class.php');
                        // $_SESSION['titre']=$titre;
                        // $title=$_SESSION['titre'];
                        
                    ?>
                    <span class="navbar-brand">MALAGASY  
                         <?php echo $_SESSION['titre'] ;?></span>
                </div>
            </div>
...
///////////////////////////////////*********************////////////////////////////////
                ...
                echo '<div class= "'.$table[$i]->categorie.'">
                    <table class= "'.$table[$i]->categorie.'">
                        ...
                        <tr  class="commentaire">
                            <td>
                                <button onclick="envoyer('.$table[$i]->id.')"><i class="fa fa-comment fa-3x"></i></button>
                            </td>
                        </tr>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        // var_dump($table);exit;
        for($i=0;$i<count($table);$i++){
            echo' <button type="button" class="btn btn-info" data-dismiss="modal" clas="btnCommenter" name="btnCommenter">commenter</button>
