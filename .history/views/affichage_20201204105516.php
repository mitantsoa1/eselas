        ...
        <form class="form-horizontal" method="POST" action="">
            ...
            <div class="form-group">
                <label class="control-label " for="id">id:</label>        
                    <input type="text" class="form-control" id="idV" placeholder="Entrer la marque de la voiture" name="id">
            </div>
            <div class="form-group">
                <label class="control-label " for="marque">Marque:</label>        
                    <input type="text" class="form-control" id="marqueV" placeholder="Entrer la marque de la voiture" name="marque">
            </div>

            <div class="form-group">
                <label class="control-label" for="matricule">Matricule:</label>         
                    <input type="text" class="form-control" id="matriculeV" placeholder="Entrer le matricule" name="matricule">
            </div>

            <div class="form-group">
                <label class="control-label" for="matricule">Couleur:</label>        
                <input type="text" class="form-control" id="couleurV" placeholder="Entrer le couleur" name="couleur">             
            </div>

            <div class="form-group">
                <label class="control-label" for="place">Nombre de place:</label>        
                <input type="text" class="form-control" id="placeV" placeholder="Entrer le nombre de places" name="place">             
            </div>
                    ...
                    <div class="form-group">  
                        <div class="row">      
                            <div class="col-sm-offset-2 col-sm-2">
                                <button type="button" name="btnSauverV" class="btn btn-warning" id="sauverV" value="Sauver">Sauver</button>
                            </div>
                        </div>
                    </div>
        </form>  
