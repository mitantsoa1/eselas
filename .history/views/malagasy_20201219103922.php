...
///////////////////////////////////*********************////////////////////////////////
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        // var_dump($table);exit;
        for($i=0;$i<count($table);$i++){
            echo' <button type="button" class="btn btn-info" data-dismiss="modal" id="btnCommenter" name="btnCommenter" onclick='EnvoyerCommenter(".$table[$i]->id.",{$("#commentContent").val()})' >commenter</button>
