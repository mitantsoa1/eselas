                    ...
                    <div class="navMenu">
                        ...
                        <div class="collapse navbar-collapse" id="navMenu">
                                <ul class="nav navbar-nav menu">
                                        <li><a href="#" class="ali">Menu1</a> </li>
                                        <li><a href="#"class="ali">Menu2</a> </li>
                                        <li><a href="#"class="ali">Menu3</a> </li>
                                        <li><a href="#"class="ali">Menu4</a> </li>
                                        <li><a href="#"class="ali">Menu5</a> </li>
                                        <li><a href="#" class="ali">Menu6</a> </li>
                                </ul> 
                        </div>
                    </div>
                </div>
