...
?>
 ...
 <div class="content container">
    ...
    <div class="row">
        <div class="col-md-5">
            <div class="title" id="title1"><img src="Publics/images/feature-img1" alt=""></div>  
        </div>
        <div class="col-md-7">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="title" id="contenu4">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptate tempore quos doloremque? Dignissimos, nesciunt repellat?</div>  
            </div>
        </div>
        <h2>VISION</h2>
    <div class="row">
