        ...
        <form class="form-horizontal" method="POST" action="">
            ...
            <div class="form-group">
                <!-- <label class="control-label " for="id">id:</label>         -->
                    <input type="hidden" class="form-control" id="id" placeholder="Enter la marque de la voiture" name="id">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">  
                <div class="row">      
                    ...
                    <div class="col-sm-offset-2 col-sm-2">
                        <a href="affichage" class="btn btn-warning" id="btnEM" value="Modifier">Modifier</a>
                    </div>
                </div>
            </div>
        </form>  
