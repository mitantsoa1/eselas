                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="accueil" class="navbar-brand" >retour à l'accueil</a></li>
                                        <li>
                                            <a href='#'  onclick='cours()'>cours </a>
                                        </li>
                                        <li>
                                            <a href='#'  onclick='exercice()'>exercice</a>
                                        </li>
                                        <li>
                                            <a href='#'  onclick='evaluation()'>evaluation</a>
                                        </li>
    ...
    ?>
        ...
        <?php
            ...
            for($i=0;$i<count($table);$i++){
                ...
                echo '<section id="idSectinAff"  class "'.$table[$i]->categorie.'"">
                    <table >
                        <tr  class="date">
