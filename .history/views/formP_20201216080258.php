  ...
  <div class="container containerFormP">
      <form id="IDformP" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="text1" name="niveau" required="required">
          </div>
          <div class="form-group">
            <label for="num_inscription" class="col-form-label">NUMERO D'INSCRIPTION:</label>
            <input type="text" class="form-control" id="text2" name="num_inscription" required="required">
          </div>
          <div class="form-group">
