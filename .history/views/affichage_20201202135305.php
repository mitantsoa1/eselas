...
<div class="container-fluid" class="affichage">
    <div class="row affichage">
        <div class="col-md-5 affichage ">

            <table class="m-t-100 table table-bordered affichage ">
                            <tr>
                                <td>ID</td>
                                <td>NOM</td>
                                <td>PRENOM</td>
                            ...
                            require_once ("Models/Database.class.php");
                                ...
                                for($i=0;$i<count($table);$i++){         
                                    ...
                                    echo "<tr>
                                            ...
                                            <a href='modifierP' id='modifierP' onclick='modifierP(".$table[$i]->id.")'>Modifier</a>
                                            </td>
    ...
    <div class="col-md-10 col-md-offset-1 affichage">
