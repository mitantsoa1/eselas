    ...
    <div class="row">
                            ...
                            require_once ("Models/Database.class.php");
                                ...
                                for($i=0;$i<count($table);$i++){         
                                    ...
                                    echo "<tr>
                                            ...
                                            <a href='affichage' id='modifierP' onclick='modifierVoit(".$table[$i]->id.")'>Modifier</a>
                                            </td>
        ...
        <div class="col-md-7">
                <table  class="m-t-100 table table-bordered">
                    ...
                    echo "<tr>
                            <td>".$table[$i]->id."</td>
                            <td>".$table[$i]->marque."</td>
                            <td>".$table[$i]->matricule."</td>
                            <td>".$table[$i]->place."</td>
                            <td>".$table[$i]->couleur."</td>
                            <td>".$table[$i]->proprietaire."</td>
                            <td>
                            <a href='affichage' id='effacer' onclick='effacer(".$table[$i]->id.")'>Effacer</a>
                            <a href='affichage' id='modifierP' onclick='modifierVoit(".$table[$i]->id.")'>Modifier</a>
                            </td>
