  ...
  <div class="container containerFormP">
      <form id="IDformP" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control input1" id="niveau" name="niveau" required="required">
          </div>
          <div class="form-group">
            <label for="num_inscription" class="col-form-label input1">NUMERO D'INSCRIPTION:</label>
            <input type="text" class="form-control input1" id="num_inscription" name="num_inscription" required="required">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <option value="1" name="professeur" selected="selected">professeur</option>
            <option value="2" name="etudiant">etudiant</option>
          </div>
