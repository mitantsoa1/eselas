    ...
    class Database {
        ...
        public function executeAff($data){
            ...
            if(strpos($this->query,"?") > -1){
                ...
                $reqA->execute($data); 
                while($tableA = $reqA->fetch(PDO::FETCH_ASSOC)){
                    var_dump($tableA);
        //             // echo $this->tableA['nom']." ".$this->tableA['prenom'];
        ...
        public function executeSP(){
                ...
                $table=[];
                $i=0;
                while($x = $req->fetch(PDO::FETCH_ASSOC)){
                    $table[$i]=$x;
                    $i++;
                }
                return $table;
