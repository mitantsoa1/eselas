        ...
        <div class="container ">
            <div class="navbar-header">
                ...
                <a class="navbar-brand js-scroll-trigger" href="#page-top">
                    <img class="img" id="logo" src="Publics/images/LOGOESELAS.png" alt="Logo ">
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active float_droite"> <a href="deconnexion" name="btnDeco" id="btnDeco" class="btn btn-danger"  onclick="return confirm('Se deconnecter?')">Se deconnecter <span class="session_user"><?php echo $_SESSION['user']; ?></span></a></li>
